...
export default function Representative() {
  return (
    <section className="overflow-x-hidden bg-bg-custom px-5 py-16 sm:px-8 sm:py-20">
      <div className="mx-auto flex w-full min-w-0 max-w-3xl flex-col items-center gap-8 sm:flex-row sm:items-start sm:gap-12">
        ...
        <div className="order-2 w-full min-w-0 max-w-full break-normal break-words text-center sm:order-none sm:text-left">
          ...
          <p className="mt-4 break-words font-mincho text-base font-semibold leading-8 text-accent sm:text-lg">
